...
class Startapps_and_projects(models.Model):
    ...
    photo = models.ImageField(upload_to='images/%Y/%m/%d/', blank=True, default='#', null=True)
    header = models.CharField(max_length=255)
    sphere = models.ForeignKey('Sphere', on_delete=models.PROTECT)
    experience = models.CharField(max_length=30, choices=experience_choice)
    ...
    applied_users = models.IntegerField(blank=True, null=True)
